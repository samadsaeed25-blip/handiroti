                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.circular(12),
                                        child: Image.asset(
                                          'assets/branding/handiroti_menu.png',
                                          fit: BoxFit.cover,
                                          errorBuilder: (context, error, stackTrace) => Image.asset(
                                            'assets/branding/handiroti_logo.png',
                                            fit: BoxFit.cover,
                                            errorBuilder: (context, error, stackTrace) =>
                                                Icon(Icons.restaurant_menu_rounded, color: cs.primary),
                                          ),
                                        ),
                                      ),
                                    ),
...
class _BrandHeader extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Premium dark hero with a more prominent, "app-store ready" brand mark.
    return Container(
      height: 290,
      ...
      child: Stack(
        fit: StackFit.expand,
        children: [
          // Soft warm glows (subtle, professional)
          Positioned(
            top: -150,
            left: -120,
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: const Color(0xFFD9B15F).withOpacity(0.10),
              ),
            ),
          ),
          Positioned(
          ...
          // A faint curved accent to add depth (like a modern food app header)
          Align(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    ...
                    colors: [
                      const Color(0xFFD9B15F).withOpacity(0.12),
          ...
          Center(
            child: TweenAnimationBuilder<double>(
              ...
              child: _BrandMark(
                assetPath: 'assets/branding/handiroti_logo.png',
              ),
            ),
          ),
        ],
...
class _BrandMark extends StatelessWidget {
  ...
  const _BrandMark({required this.assetPath});
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        // Rounded-square glass plate (delivery-app hero look)
        ClipRRect(
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: RadialGradient(
              colors: [
                const Color(0xFFD9B15F).withOpacity(0.38),
                const Color(0xFFD9B15F).withOpacity(0.00),
              ],
            ),
          ),
        ),

        // Frosted badge behind the logo
        ClipRRect(
