...
class _PhoneAuthScreenState extends State<PhoneAuthScreen> {
  ...
  Future<void> _sendOtp({bool isResend = false}) async {
    ...
    try {
      ...
      // Analytics
      unawaited(FirebaseAnalytics.instance.logLogin(loginMethod: 'phone'));await PushService.registerFromFirebaseUser();
            if (!mounted) return;
          ...
          child: Column(
            ...
            children: [
              ...
              if (kDebugMode) ...[
                const SizedBox(height: 14),
                Text(
                  "Login tip: Use your phone number.\nExample: +971512340000 / code 00000",
